...
class ghz_naive:
  ...
  def ghz_9_circ(self):
    ...
    # Sequentially spread entanglement
    self.qc_9.h(3) #layer1
    self.qc_9.cx(3,0) #layer2
    self.qc_9.cx(3,1) #layer3
    self.qc_9.cx(1,2) #layer4
    self.qc_9.cx(3,4) #layer5
    self.qc_9.cx(3,5) #layer6
    self.qc_9.cx(5,6) #layer7
    self.qc_9.cx(6,7) #layer8
    self.qc_9.cx(7,8) #layer9
    return self.qc_9
  def ghz_depth(self):
